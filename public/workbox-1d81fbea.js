define(["exports"], function(t) {
    ...
    function x(t) {
        return t !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (g || (g = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function(...e) {
    ...
    function I(t) {
        return "function" == typeof t ? x(t) : (t instanceof IDBTransaction && function(t) {
            ...
            v.set(t, e)
        }(t), e = t, (m || (m = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(t => e instanceof t) ? new Proxy(t, U) : t);
        var e
    }
    ...
    class F {
        constructor(t, e) {
            this.C = {}, Object.assign(this, e), this.event = e.event, this.N = t, this.O = new K, this.k = [], this.B = [...t.plugins], this.T = new Map;
    ...
    class H {
        ...
        async M(t, e, n) {
            ...
            try {
                if (i = await this.j(e, t), !i || "error" === i.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
    ...
    class Y extends H {
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this.K = !1 !== t.fallbackToNetwork, this.plugins.push(Y.copyRedirectedCacheableResponsesPlugin)
        }
        async j(t, e) {
    ...
    class Z {
        constructor({
            ...
            this.$ = new Map, this.G = new Map, this.V = new Map, this.N = new Y({
                cacheName: f(t),
                plugins: [...e, new J({
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {
                    cacheKey: t,
                    url: i
                } = G(n), r = "string" != typeof n && n.revision ? "reload" : "default";
    ...
    t.CacheFirst = class extends H {
        ...
        constructor(t) {
            this.cacheWillUpdate = async ({
                response: t
            }) => this.X.isResponseCacheable(t) ? t : null, this.X = new W(t)
        }
        ...
        constructor(t = {}) {
            super(t), this.plugins.some(t => "cacheWillUpdate" in t) || this.plugins.unshift(j), this.nt = t.networkTimeoutSeconds || 0
        }
        async j(t, e) {
            const n = [],
                i = [];
